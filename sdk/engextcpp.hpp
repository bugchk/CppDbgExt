...
public:
	...
	void WINAPI Set(ULONG64 pThread) throw(...);
	static ULONG64 WINAPI Get() throw(...);
...
public:
	...
	bool Is64bitPtr(void)
	{
		return m_Control->IsPointer64Bit() == S_OK;
	}
    ...
    void WINAPIV Out(_In_ PCSTR Format,
                     ...);
	void WINAPIV OutLine(_In_ PCSTR Format,
		...);
    ...
    void WINAPIV Verb(_In_ PCSTR Format,
                      ...);
	void WINAPIV Status(_In_ PCSTR Format,
		...);
	void WINAPIV Out(_In_ PCWSTR Format,
                     ...);
	void WINAPIV OutLine(_In_ PCWSTR Format,
		...);
    ...
    void WINAPIV Verb(_In_ PCWSTR Format,
                      ...);
	void WINAPIV Status(_In_ PCWSTR Format,
		...);
	...
	void WINAPIV OutTimeString(ULONG64 mSec);
	...
	ULONG64 GetUlong64(_In_ PCSTR Str) throw(...);
	LONG64 GetLong64(_In_ PCSTR Str) throw(...);
	ULONG GetUlong(_In_ ULONG64 Addr) throw(...);
	LONG GetLong(_In_ ULONG64 Addr) throw(...);
	ULONG64 GetUlong64(_In_ ULONG64 Addr) throw(...);
	LONG64 GetLong64(_In_ ULONG64 Addr) throw(...);
    ...
    virtual void WINAPI ExInitialize(void) throw(...);
...
public:
	...
	ULONG64 VirtualAddress() { return m_Data ? m_Data : m_Offset; }
	std::string VirtualAddressString() 
	{ 
		CHAR buf[16+1] = {0};
		_snprintf_s(buf, sizeof(buf), "%llx", this->VirtualAddress());
